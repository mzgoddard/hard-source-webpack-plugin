...
var dataSerializer = require('hard-source-webpack-plugin/lib/CacheSerializerFactory').dataSerializer;
...
exports.compile = function(fixturePath, options) {
  var configPath = path.join(process.cwd(), 'fixtures', fixturePath, 'webpack.config.js');
...
exports.writeFiles = function(fixturePath, files) {
  var configPath = path.join(process.cwd(), 'fixtures', fixturePath);
...
exports.readFiles = function(outputPath) {
  outputPath = path.join(process.cwd(), 'fixtures', outputPath);
  ...
  it(name, function() {
    ...
    .then(function() {
      var serializer = dataSerializer.createSerializer({
        name: 'md5',
        cacheDirPath: path.join(process.cwd(), 'fixtures', fixturePath, 'tmp/cache')
      });
...
exports.itCompilesHardModules = function(fixturePath, filesA, filesB, expectHandle) {
  ...
  exports.itCompiles('builds hard modules in ' + fixturePath + ' fixture', fixturePath, function() {
    ...
    var hardModules = [];
    var shortener = new (require('webpack/lib/RequestShortener'))(path.resolve(process.cwd(), 'fixtures', fixturePath));
...
exports.clean = function(fixturePath) {
  var tmpPath = path.join(process.cwd(), 'fixtures', fixturePath, 'tmp');
  var nmPath = path.join(process.cwd(), 'fixtures', fixturePath, 'node_modules');
  return Promise.all([
