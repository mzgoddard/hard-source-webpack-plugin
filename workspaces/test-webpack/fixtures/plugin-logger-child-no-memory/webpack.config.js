...
var pluginCompat = require('hard-source-webpack-plugin/lib/util/plugin-compat');
...
module.exports = {
  ...
  plugins: [
    ...
    },
    {
      apply: function(compiler) {
        var lines = [];
        pluginCompat.tap(compiler, 'hardSourceLog', 'NoMemoryCache', function(
          info,
        ) {
          if (info.level === 'error') {
        ...
        pluginCompat.tap(compiler, 'emit', 'NoMemoryCache', function(
          compilation,
        ) {
