...
HardSourceWebpackPlugin.prototype.apply = function(compiler) {
  ...
  compiler.plugin(['watch-run', 'run'], function(compiler, cb) {
    ...
    hashCache.setDependencies(dataCache.fileDependencies, dataCache.contextDependencies);
  ...
  compiler.plugin('after-compile', function(compilation, cb) {
    ...
    if (compiler.__hardSource_topCompilation === compilation) {
      ...
      hashCache.setDependencies(compilation.fileDependencies, compilation.contextDependencies);
      md5Ops = hashCache.save({mtime: mtime, md5: md5, stat: stat, readdir: readdir});
