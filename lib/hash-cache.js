...
HashCache.prototype._contextStamps = function(fs, contextDependencies) {
  ...
  return bluebird.all(contextDependencies.map(function(contextPath) {
...
HashCache.prototype.buildHashes = function(fs) {
  ...
  return bluebird.all([
    bluebird.all(_this._fileDependencies.map(function(file) {
      return fs.stat(file)
    ...
    (function() {
      ...
      .then(function(contexts) {
        for (var contextPath in contexts) {
          ...
          fileTs[contextPath] = context.mtime;
...
HashCache.prototype.save = function(fs) {
  ...
  fileDependencies.forEach(function(file) {
    ...
    buildingMd5s[file] = bluebird.props({
      file: file,
  ...
  return bluebird.all(Object.keys(buildingMd5s).map(function(key) {
