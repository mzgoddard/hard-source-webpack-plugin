...
class HardBasicDependencyPluginLegacy {
  constructor(options) {
  ...
  apply(compiler) {
    ...
    pluginCompat.tap(
      compiler,
      'afterPlugins',
      'HardBasicDependencyPlugin scan Dependency types',
      () => {
        pluginCompat.tap(
          compiler,
          'compilation',
          'HardBasicDependencyPlugin scan Dependencies types',
          ({ dependencyFactories }) => {
    ...
    pluginCompat.tap(
      ...
      'HardBasicDependencyPlugin after freeze',
      (frozen, dependency, extra) => {
...
module.exports = HardBasicDependencyPluginLegacy;
