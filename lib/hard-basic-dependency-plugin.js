...
class HardBasicDependencyPlugin {
  ...
  apply(compiler) {
    ...
    pluginCompat.tap(compiler, 'afterPlugins', 'HardBasicDependencyPlugin scan Dependency types', () => {
      pluginCompat.tap(compiler, 'compilation', 'HardBasicDependencyPlugin scan Dependencies types', ({dependencyFactories}) => {
    ...
    pluginCompat.tap(compiler, '_hardSourceFreezeDependency', 'HardBasicDependencyPlugin freeze', (frozen, dependency, extra) => {
    ...
    pluginCompat.tap(compiler, '_hardSourceThawDependency', 'HardBasicDependencyPlugin', (dependency, frozen, extra) => {
      extra.schemas = schemas;
    ...
    pluginCompat.tap(compiler, '_hardSourceAfterThawDependency', 'HardBasicDependencyPlugin', (dependency, {loc, optional, warnings}, extra) => {
      if (dependency && loc) {
        dependency.loc = loc;
      }
