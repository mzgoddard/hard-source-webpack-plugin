...
const FileSerializerPlugin = require('./hard-source-file-serializer-plugin');
const AppendSerializerPlugin = require('./hard-source-append-serializer-plugin');
 ...
 */
CacheSerializerFactory.dataSerializer = AppendSerializerPlugin;
