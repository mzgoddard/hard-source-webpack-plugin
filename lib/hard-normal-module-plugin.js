...
class HardNormalModulePlugin {
  ...
  apply(compiler) {
    ...
    pluginCompat.tap(compiler, '_hardSourceMethods', 'HardNormalModulePlugin', methods => {
      _methods = methods;
    ...
    pluginCompat.tap(compiler, '_hardSourceFreezeModule', 'HardNormalModulePlugin', (frozen, module, extra) => {
    ...
    pluginCompat.tap(compiler, '_hardSourceThawModule', 'HardNormalModulePlugin thaw', (module, frozen, {compilation, normalModuleFactory}) => {
