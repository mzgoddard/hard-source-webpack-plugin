  ...
  compiler.plugin('--hard-source-freeze-module', function(frozen, module, extra) {
    if (
      ...
      return {
        ...
        hashContentDigest: freezeHashContentDigest(module, compilation.dependencyTemplates),
      ...
      frozen &&
      module.getHashDigest(extra.compilation.dependencyTemplates) !== frozen.hashContentDigest
    ) {
      var compilation = extra.compilation;
      var source = module.source(
        compilation.dependencyTemplates,
