...
class HardSourceSourcePlugin {
  apply(compiler) {
    let methods;

    pluginCompat.tap(compiler, '_hardSourceMethods', 'HardSourceSourcePlugin', _methods => {
      methods = _methods;
    });

    pluginCompat.tap(compiler, '_hardSourceFreezeSource', 'HardSourceSourcePlugin freeze', (frozen, source, extra) => {
    ...
    pluginCompat.tap(compiler, '_hardSourceThawSource', 'HardSourceSourcePlugin thaw', (source, frozen, extra) => {
